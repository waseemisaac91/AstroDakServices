  ...
  const projectsData: Project[] = [
    {
      ...
      category: "flatRoofs",
      image: "project/components/img/Bitumen platdak isolatie1.jpg",
    },
    {
      id: 2,
      ...
      description: "Bitumen platdak isolatie",
      category: "flatRoofs",
      image: " project/components/img/Bitumen platdak isolatie2.jpg",
    },
    {
      id: 3,
      ...
      image: "project/components/img/Dakpannen1.jpg",
    },
    {
      id: 4,
      ...
      description: "Dakpannen",
      category: "slopedRoofs",
      image: "project/components/img/Dakpannen2.jpg",
    },
    {
      id: 5,
      title: t("services.slopedRoofs.title"),
      description: "Dakpannen",
      category: "slopedRoofs",
      image: "project/components/img/Dakpannen3.jpg",
    },
    {
      id: 6,
      title: t("services.flatRoofs.title"),
      ...
      category: "flatRoofs",
      image: "project/components/img/lichtKoepel1.jpg",
    },
    {
      id: 7,
      title: t("services.flatRoofs.title"),
      description: "lichtKoepel",
      category: "flatRoofs",
      image: "project/components/img/lichtKoepel2.jpg",
    },
    {
      id: 8,
      ...
      category: "chimney",
      image: "project/components/img/schoorsteen1.jpg",
    },
    {
      id: 9,
      ...
      description: "Schoorsteen",
      category: "chimney",
      image: "project/components/img/schoorsteen2.jpg",
    },
    {
      id: 10,
      title: t("services.flatRoofs.title"),
      description: "Bitumen platdak isolatie",
      category: "flatRoofs",
      image: "project/components/img/Bitumen platdak isolatie3.jpg",
    },
    {
      id: 11,
      title: t("services.flatRoofs.title"),
      description: "Bitumen platdak isolatie",
      category: "flatRoofs",
      image: "project/components/img/Bitumen platdak isolatie4.jpg",
    },
    {
      id: 12,
      title: t("services.slopedRoofs.title"),
      description: "Dakraam",
      category: "slopedRoofs",
      image: "project/components/img/Dakraam vervangen1.jpg",
    },
    {
      id: 13,
      ...
      description: "Dakgoot",
      category: "zincWork",
      image: "project/components/img/Zinkwerk-Dakgootset.jpg",
    },
    {
      id: 14,
      ...
      description: "Dakgoot",
      category: "zincWork",
      image: "project/components/img/Zinkwerk-Dakgootset2.jpg",
    },
    {
      id: 15,
      title: t("services.zincWork.title"),
      description: "Dakgoot",
      category: "zincWork",
      image: "project/components/img/Zinkwerk-Dakgootset3.jpg",
    },

    {
      ...
      description: "Kilgoot",
      category: "zincWork",
      image: "project/components/img/kilgoot.jpg",
    },
  ];
