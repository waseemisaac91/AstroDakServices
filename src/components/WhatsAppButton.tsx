        ...
        >
          <div className="relative group">
            <motion.div
              ...
              className="absolute -top-10 right-0 bg-gray-800 text-white text-sm py-2 px-4 rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none whitespace-nowrap"
            >
              {t("whatsapp.tooltip")}
